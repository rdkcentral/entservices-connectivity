...
// Placeholder for bluetooth-sdk's bluetooth/Device.h — see Status.h in the
// parent directory for why this file exists and when to remove it.
//
// bluetooth::Device is abstract here (no sdbus-c++ proxy base, no exposed
// data layout) so it stays valid regardless of how the SDK team's real
// refactor hides D-Bus internals. BtSdkAdapterImpl only ever holds devices as
// shared_ptr<Device> handed back by Manager/Adapter, never constructs one.
#pragma once
